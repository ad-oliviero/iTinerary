...
enum GeometryCoordinate: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        throw DecodingError.typeMismatch(GeometryCoordinate.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for GeometryCoordinate"))
    }
...
enum CoordinateCoordinate: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        throw DecodingError.typeMismatch(CoordinateCoordinate.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for CoordinateCoordinate"))
    }
...
enum Istat: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        throw DecodingError.typeMismatch(Istat.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for Istat"))
    }
