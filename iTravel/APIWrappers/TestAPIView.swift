        ...
        NavigationStack {
            VStack {
                Button {
                    Task {
                        do {
//                                let request = IsoLinesAPIRequest(lat: "40.8358846", lon: "14.2487679", isoType: .isochrone, mode: .car, range: 300)
...
//                            print(try await request.responseToJson())
                        ...
                        do {
//                                let request = PlacesAPIRequest(placeId: "51a8c64b3789792c40597fdfbf79716e4440c00206e2031e77686f736f6e66697273743a6c6f63616c6974793a313031373532353535", categories: Category.allCases.map {$0}, limit: 10, offset: 0)
//                                try await request.sendRequest()
//                            print(try await request.responseToJson())
                        } catch {
                            print(error.localizedDescription)
